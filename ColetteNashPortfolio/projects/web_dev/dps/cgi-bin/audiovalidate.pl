...
# Check that input received is expected
  ...
  if (($username eq expectedUser) && ($password eq expectedPass)) {
...
____audioCode
     ...
     <body>
     Credentials not recognised. Press <a href="/~it.coletten/cgi-bin/audiovalidate.pl">here</a> to try again.
     </head>
     </html>
_____loginFail
  }
 ...
 # }
  ...
  <body>
  <form action="audiovalidate.pl" method="POST">
  <h1>Please login</h1>
